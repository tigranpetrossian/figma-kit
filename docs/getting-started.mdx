...
### Import Figma Kit styles without Tailwind
...
If your project uses Tailwind v4, import `figma-kit/tailwind.css` instead. It includes the component styles, so do not import both entries:
