...
export const ShadowLeftIcon = createIcon({
  displayName: 'ShadowLeft',
  path: (
    <>
      <path
        fill="var(--color-icon)"
      ...
      />
      <path fill="var(--color-icon-tertiary)" d="M8 6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z" />
    </>
  ),
});
