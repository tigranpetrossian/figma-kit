...
export const ShadowBottomLeftIcon = createIcon({
  displayName: 'ShadowBottomLeft',
  path: (
    <>
      <path
        fill="var(--color-icon)"
      ...
      />
      <path fill="var(--color-icon-tertiary)" d="M6 8v8a2 2 0 0 0 2 2h8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8a2 2 0 0 1 1.796-1.99z" />
    </>
  ),
});
