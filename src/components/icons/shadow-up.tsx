...
export const ShadowUpIcon = createIcon({
  displayName: 'ShadowUp',
  path: (
    <>
      <path
        fill="var(--color-icon)"
      ...
      />
      <path fill="var(--color-icon-tertiary)" d="M16 3a2 2 0 0 1 2 2v3a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2V5a2 2 0 0 1 2-2z" />
    </>
  ),
});
