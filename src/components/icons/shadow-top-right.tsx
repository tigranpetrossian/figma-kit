...
export const ShadowTopRightIcon = createIcon({
  displayName: 'ShadowTopRight',
  path: (
    <>
      <path
        fill="var(--color-icon)"
      ...
      />
      <path fill="var(--color-icon-tertiary)" d="M18 4a2 2 0 0 1 2 2v8a2 2 0 0 1-1.796 1.99L18 16V8a2 2 0 0 0-2-2H8a2 2 0 0 1 2-2z" />
    </>
  ),
});
