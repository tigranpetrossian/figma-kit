...
export const ShadowTopLeftIcon = createIcon({
  displayName: 'ShadowTopLeft',
  path: (
    <>
      <path
        fill="var(--color-icon)"
      ...
      />
      <path fill="var(--color-icon-tertiary)" d="M14 4a2 2 0 0 1 2 2H8a2 2 0 0 0-2 2v8l-.204-.01A2 2 0 0 1 4 14V6a2 2 0 0 1 2-2z" />
    </>
  ),
});
